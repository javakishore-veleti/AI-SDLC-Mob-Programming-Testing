---
name: risk-management-mob-programming
description: use this skill to run ai-sdlc mob programming governance sessions for identifying, assessing, prioritizing, mitigating, accepting, and tracking delivery, architecture, security, compliance, operational, and business risks.
---

# Risk Management AI-SDLC Mob Programming Playbook

## Purpose

Use this SKILL.md as an **AI-SDLC Mob Programming governance playbook** for risk identification, mitigation, ownership, and acceptance.
...
- Feature or integration risk review
- Production readiness risk review
- Vendor or third-party risk review
- Security and compliance risk review
- Architecture risk review
- Operational risk review
- Risk acceptance decision session
...
### 1. Risk Discovery
Identify risks across business, architecture, security, compliance, testing, operations, delivery, and vendors.

### 2. Risk Scoring
Score probability, impact, severity, detectability, and urgency.

### 3. Mitigation Design
Define mitigation, contingency, monitoring, and recovery actions.

### 4. Risk Acceptance
Decide which risks are mitigated, transferred, accepted, or avoided.
...
Help the team run a governance-focused mob session for risk identification, mitigation, ownership, and acceptance.
...
- `governance/risk-management/risk-register.md`
- `governance/risk-management/risk-mitigation-plan.md`
- `governance/risk-management/risk-acceptance-log.md`
- `governance/risk-management/assumptions-and-dependencies.md`
- `governance/risk-management/governance-actions.md`
