---
name: policy-as-code-governance-mob-programming
description: use this skill to run ai-sdlc mob programming governance sessions for policy-as-code, automated controls, guardrails, cloud policy, kubernetes admission policy, infrastructure policy, and compliance automation.
---

# Policy-as-Code Governance AI-SDLC Mob Programming Playbook

## Purpose

Use this SKILL.md as an **AI-SDLC Mob Programming governance playbook** for policy-as-code and automated governance controls.
...
### 1. Policy Objective
Define what risk or standard the policy enforces.

### 2. Policy Scope
Identify systems, repositories, environments, and enforcement points.

### 3. Enforcement Model
Decide advisory vs blocking, pre-commit vs pipeline vs runtime, and exception flow.

### 4. Developer Experience
Ensure guardrails guide teams without creating unnecessary friction.

### 5. Evidence and Reporting
Define audit evidence, violation reporting, and policy ownership.
...
Help the team run a governance-focused mob session for policy-as-code and automated governance controls.
...
- `governance/policy-as-code/policy-catalog.md`
- `governance/policy-as-code/enforcement-model.md`
- `governance/policy-as-code/exception-process.md`
- `governance/policy-as-code/developer-guidance.md`
- `governance/policy-as-code/compliance-reporting.md`

---

## Governance Readiness Checklist

- [ ] Policy objective defined
- [ ] Enforcement point selected
- [ ] Blocking rules defined
- [ ] Exceptions process documented
- [ ] Developer guidance created
