---
name: architecture-governance-mob-programming
description: use this skill to run ai-sdlc mob programming governance sessions for architecture review, architecture decision records, design standards, technology choices, integration patterns, exception handling, and implementation readiness governance.
---

# Architecture Governance AI-SDLC Mob Programming Playbook

## Purpose

Use this SKILL.md as an **AI-SDLC Mob Programming governance playbook** for architecture governance, decision review, and design accountability.
...
- Architecture review for new capabilities
- Technology selection governance
- Integration pattern review
- API and event architecture review
- Cloud or platform architecture review
- Architecture exception review
- Reusable standards and reference architecture governance
...
Define the capability, systems, dependencies, constraints, and business drivers.

### 2. Decision Inventory
Identify architecture decisions required:
...
Compare options using scalability, security, cost, maintainability, reliability, and delivery speed.

### 4. Governance Review
Confirm standards, exceptions, policy impact, and approval needs.

### 5. Decision Capture
Create ADRs and follow-up actions.
...
Help the team run a governance-focused mob session for architecture governance, decision review, and design accountability.
...
- `governance/architecture-governance/architecture-review.md`
- `governance/architecture-governance/architecture-decision-log.md`
- `governance/architecture-governance/adr-0001.md`
- `governance/architecture-governance/architecture-exceptions.md`
- `governance/architecture-governance/implementation-readiness-impact.md`
...
- [ ] Standards impact reviewed
- [ ] Exceptions identified
- [ ] ADRs created
- [ ] Open decisions tracked
- [ ] Approval owners identified
