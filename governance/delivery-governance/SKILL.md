---
name: delivery-governance-mob-programming
description: use this skill to run ai-sdlc mob programming governance sessions for delivery readiness, stage gates, implementation governance, quality gates, release readiness, dependency governance, and cross-functional accountability.
---

# Delivery Governance AI-SDLC Mob Programming Playbook

## Purpose

Use this SKILL.md as an **AI-SDLC Mob Programming governance playbook** for delivery readiness, quality gates, and implementation governance.
...
### 1. Delivery Context
Define capability, teams, timeline, dependencies, risks, and success criteria.

### 2. Gate Definition
Define required gates: business, architecture, security, testing, DevOps, SRE, compliance, and release.

### 3. Evidence Required
Define what evidence proves readiness for each gate.

### 4. Ownership Model
Assign accountable owners for decisions, approvals, follow-ups, and exceptions.

### 5. Governance Dashboard
Define status reporting without creating excessive process overhead.
...
Help the team run a governance-focused mob session for delivery readiness, quality gates, and implementation governance.
...
- `governance/delivery-governance/delivery-readiness-scorecard.md`
- `governance/delivery-governance/governance-gates.md`
- `governance/delivery-governance/evidence-checklist.md`
- `governance/delivery-governance/dependency-governance.md`
- `governance/delivery-governance/exception-register.md`

---

## Governance Readiness Checklist

- [ ] Delivery scope clear
- [ ] Governance gates defined
- [ ] Evidence required per gate documented
- [ ] Owners assigned
- [ ] Dependencies tracked
- [ ] Exceptions captured
- [ ] Quality gates reviewed
- [ ] Release readiness criteria defined
- [ ] Dashboard/reporting model defined
