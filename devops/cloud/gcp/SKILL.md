---
name: gcp-cloud-deployment-mob-programming
description: use this skill to run ai-sdlc mob programming sessions for gcp cloud deployment architecture, identity, networking, compute, kubernetes, observability, security, cost, disaster recovery, and operational readiness.
---

# GCP Cloud Deployment AI-SDLC Mob Programming Playbook

## Purpose

Use this SKILL.md as an **AI-SDLC Mob Programming playbook** for GCP cloud deployment architecture and operational readiness.
...
- New GCP application deployment
- GCP landing zone review
...
|---|---|
| GCP Console / Portal | Review cloud resources, identity, networking, compute, and monitoring |
...
|---|---|
| GCP read/admin access | Review cloud architecture and resources |
...
```text
IAM, VPC, GKE, Cloud Run, Cloud Functions, Cloud Monitoring, Secret Manager, Cloud Storage
```
...
Help the team run a mob session for GCP cloud deployment architecture and operational readiness.
...
- `devops/cloud/gcp/architecture-review.md`
- `devops/cloud/gcp/identity-access-review.md`
- `devops/cloud/gcp/networking-review.md`
- `devops/cloud/gcp/deployment-readiness.md`
- `devops/cloud/gcp/operational-readiness.md`
- `devops/cloud/gcp/cost-and-resilience-review.md`
