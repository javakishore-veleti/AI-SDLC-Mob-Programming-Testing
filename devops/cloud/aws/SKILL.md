---
name: aws-cloud-deployment-mob-programming
description: use this skill to run ai-sdlc mob programming sessions for aws cloud deployment architecture, identity, networking, compute, kubernetes, observability, security, cost, disaster recovery, and operational readiness.
---

# AWS Cloud Deployment AI-SDLC Mob Programming Playbook

## Purpose

Use this SKILL.md as an **AI-SDLC Mob Programming playbook** for AWS cloud deployment architecture and operational readiness.
...
- New AWS application deployment
...
|---|---|
| AWS Console / Portal | Review cloud resources, identity, networking, compute, and monitoring |
...
|---|---|
| AWS read/admin access | Review cloud architecture and resources |
...
```text
IAM, VPC, EKS, ECS, Lambda, RDS, CloudWatch, CloudTrail, S3, Route53, ALB, Secrets Manager
```
...
Help the team run a mob session for AWS cloud deployment architecture and operational readiness.
...
- `devops/cloud/aws/architecture-review.md`
- `devops/cloud/aws/identity-access-review.md`
- `devops/cloud/aws/networking-review.md`
- `devops/cloud/aws/deployment-readiness.md`
- `devops/cloud/aws/operational-readiness.md`
- `devops/cloud/aws/cost-and-resilience-review.md`
